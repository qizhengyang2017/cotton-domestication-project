...
basedir=/path/to/SNP_calling_0620

cat du_first_02|while read i
do

fq1=/data/cotton/TMP/CAAS_DNASeq/fastq/${i}_clean.1.fq.gz
fq2=/data/cotton/TMP/CAAS_DNASeq/fastq/${i}_clean.2.fq.gz

fasta=/path/to/vcf_call_101/Ghirsutum_genome.fasta
